...
from rsl_rl.algorithms.ppo_beta import PPO_Beta
...
class OnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg, log_dir=None, device="cpu"):
        ...
        actor_critic: ActorCritic | ActorCriticSG | ActorCriticBeta | ActorCriticRecurrent = actor_critic_class(
            num_obs, num_critic_obs, self.env.num_actions, **self.policy_cfg
        ).to(self.device)
        alg_class = eval(self.alg_cfg.pop("class_name"))  # PPO
        self.alg: PPO | PPO_Beta = alg_class(actor_critic, device=self.device, **self.alg_cfg)
